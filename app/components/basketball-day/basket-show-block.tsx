...
const BasketShow = ({ isMobile }: BasketShowProps) => {
    ...
    return (
        <div className={"relative pt-4 md:mt-16 pb-4 md:pb-24"}>
            <div className={"flex flex-col justify-center items-center gap-8 md:gap-16"}>
                ...
                <div className={"flex flex-col justify-center items-center gap-8 md:gap-16 sm:px-20 md:px-64"}>
                    ...
                    Представители студенческих спортивных клубов встретятся с командой Медийной лиги. Они продемонстрируют свои навыки и силу в баскетболе 3х3. Хочешь стать частью команды, участвуй в челлендже!`}
                    </p>
