    ...
    return (
        <div className={"relative md:mt-20 pb-16 md:pb-64 px-5 sm:px-20 md:px-64"}>
            <div className={"flex justify-center items-center flex-col gap-16"}>
                {isMobile
                    ?
                    <p className='font-regular text-xl text-blue' style={{ lineHeight: "20px", whiteSpace: "pre-line" }}>{`Приглашаем вас окунуться в мир цифровых видов спорта на киберарене! Вас ждут захватывающие соревнования и шоу-матчи. Не пропустите эфир со знаменитым киберспортсменом — Михаилом Dosia Столяровым. 
                    ...
                    :
                    <p className='font-medium text-2xl text-blue' style={{ lineHeight: "32px", whiteSpace: "pre-line" }}>{`Приглашаем вас окунуться в мир цифровых видов спорта на киберарене! Вас ждут захватывающие соревнования и шоу-матчи. Не пропустите эфир со знаменитым киберспортсменом — Михаилом Dosia Столяровым. 
