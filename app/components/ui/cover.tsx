...
const Cover = ({ title }: CoverProps) => {
  return (
    <div className={"w-full h-[586px] md:h-[672px] relative"}>
      ...
      <div className={
        "bg-[url('/images/mobile/bg/cover-bg.svg')] md:bg-[url('/images/desktop/bg/cover-bg.svg')] bg-no-repeat bg-center w-full h-full absolute top-0 left-0 md:pt-60"
      }>
        {title
          ?
          <div className="z-20 flex justify-center items-center h-[100%] md:h-fit w-[100%] ">
      ...
      <div className={"absolute bottom-0 left-0 right-0 z-20"}>
        <div className={"flex flex-col justify-center items-center mb-[150px] md:mb-32"}>
